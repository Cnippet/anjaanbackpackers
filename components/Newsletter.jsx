        ...
        >
            ...
            <div className='mx-auto max-w-7xl px-6 py-16 lg:py-24 lg:px-8'>
                <div className='relative isolate overflow-hidden sm:px-24'>
                    ...
                    <p className='mt-4 mx-auto max-w-xl text-center text-sm text-gray-950 sm:text-base' data-aos="fade-up"  data-aos-duration="500">
                    ...
                    <form action='' className='mt-6 mx-auto max-w-md col-span-5 lg:py-2' data-aos="fade-down" data-aos-duration="500">

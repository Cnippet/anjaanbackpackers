                ...
                <div className='mx-auto grid gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none grid-cols-12'>
                    <div className='col-span-12 lg:pr-8 lg:pt-4 lg:col-span-7'>
                        <div className=''>
                            ...
                            <ul className='mt-10 ml-5 max-w-xl text-base leading-7 text-gray-600 lg:max-w-none' data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <div className="mt-10 flex gap-x-6" data-aos="fade-up" data-aos-duration="1000">

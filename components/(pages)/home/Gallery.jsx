...
import G1 from "@/public/images/D1.jpg";
import G2 from "@/public/images/D2.jpg";
import G3 from "@/public/images/D3.jpg";
import G4 from "@/public/images/R2.jpg";
import G5 from "@/public/images/L3.png";
import G6 from "@/public/images/R3.jpg";


const Gallery = () => {
    return (
        <section id="gallery" className="relative isolate py-8 lg:py-16">
            <div className="max-w-[90%] min-h-[50vh] mx-auto px-8">
                <div className="flex mb-10 flex-col justify-between gap-y-5 py-4 md:gap-x-10 lg:flex-row">
                    ...
                    <p className="my-auto max-w-xl text-base leading-8 text-gray-900 md:text-lg">
                        Explore our beautiful collection of photos featuring beauty of Uttarakhand.
                    </p>
                </div>
                        ...
                        <div className="flex flex-row gap-4">
                            <div className="rounded-2xl overflow-hidden">
                                <Image
                                    src={G3}
                                    alt="aa"
                                    className="block w-full h-64 object-cover origin-center hover:scale-[1.04] transition-all ease-in duration-200"
                                />
                            </div>
                            <div className="rounded-2xl overflow-hidden">
                                <Image
